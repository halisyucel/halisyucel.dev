...
export type HomeModelAboutField = {
  __typename?: 'HomeModelAboutField';
...
/** Record of type Home (home) */
export type HomeRecord_AllAboutLocalesArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  locale?: InputMaybe<SiteLocale>;
};
...
/** Record of type Home (home) */
export type HomeRecordAboutArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  locale?: InputMaybe<SiteLocale>;
};
...
export type ProjectModelFilter = {
  ...
  writtenLanguage?: InputMaybe<StringFilter>;
};
...
export enum ProjectModelOrderBy {
  ...
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC',
  WrittenLanguageAsc = 'writtenLanguage_ASC',
  WrittenLanguageDesc = 'writtenLanguage_DESC'
}
...
/** Record of type Project (project) */
export type ProjectRecord_AllDescriptionLocalesArgs = {
  locale?: InputMaybe<SiteLocale>;
